...
- 2026-08-16: Implemented the strict v2 pointer, required manifest, public
  correlation section, complete outcome/failure matrix, and digest-addressed
  sanitized-log boundary.
