...
| `test-runner` | Pool fallback regression | supported | [SPEC.md](test-runner/pool-fallback-regression/SPEC.md) | Validate pool transitions and settings saves with temporary local pools and verified cleanup. |
...
| `test-runner` | Mock-device integration | supported | [SPEC.md](test-runner/mock-device-integration/SPEC.md) | Exercise the real Gamma lifecycle and fake Stratum path without physical hardware. |
